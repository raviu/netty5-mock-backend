...
public class MockServerDelayThread1 extends Thread {

    private static final DelayQueue<DelayedElement>  queue = new DelayQueue<DelayedElement>();
    ...
    public static void delayEvent(ChannelHandlerContext ctx, LastHttpContent trailer, HttpRequest request, StringBuilder buf, int delay, String responseContentType) {
        DelayedElement delayedElement = new DelayedElement(ctx, trailer, request, HardcodedResponse.getRandomUUID(), System.currentTimeMillis(), delay, responseContentType);
